  ...
  if ($num >= 1 && $num <= 48) :
      ...
      if (isset($_GET['correction']) && in_array($_GET['correction'], ['exercice1', 'exercice2'])):
          ...
          <div style="margin: 0; padding: 0; height: 100vh;">
              ...
              <a id="lien-py" href="<?= "?f.php&fichier={$sujetPhp}/corrige/exercice{$correctionPhp}.py" ?>">
      ...
      <?php else: ?>
        <div>
          ...
          🔗 <a href="?f.php&fichier=<?php echo $sujet; ?>/sujet-<?php echo $num; ?>.py">Télécharger le fichier Python</a><br>
          </div>
